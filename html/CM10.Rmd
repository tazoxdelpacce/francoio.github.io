...
Soit $F(t)$ une fonction de r\'epatitition, $u \in (0,1)$ et $F^{-1}(u) = \inf \{ t \in \mathbb{R} , \quad F(t) \geq u \}$. Soit $U$ une variable de loi uniforme sur $(0,1)$, alors
$$
X = F^{-1}(U) 
$$
