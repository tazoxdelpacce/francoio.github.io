--- 
title: "Cours Magistral 3"
output: html_document 
---

** **

#### Définition de l'espérance mathématique d'une variable aléatoire
...
Soit $\alpha_1,\dot, \alpha_n$, $n$ **coefficients positifs** et $A_1, \dots , A_n$, $n$ événements. On appelle variable étagée, la variable  
...
* Soit $X$ une variable aléatoire réelle. On dit que $X$ est {\bf intégrable} si $\mathbb{E}[|X|]<\infty$. Dans ce cas, nous avons
