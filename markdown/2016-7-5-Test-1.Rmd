...
Le [formulaire de réponse](https://github.com/francoio/francoio.githib.io/Rmd/Formulaire-Test-1.md) à déposer dans TEIDE est disponible sur GitHub.
...
On définit la variable aléatoire $Y$ égale au nombre de joueurs ayant atteint la cible au second tir aprés l'avoir ratée au premier tir. 
